...
/** PISTE DE REFLEXION
 * Ici pour le calcul de la distance au cercle on calcul � chaque fois le rayon du cercle en question
 * Il faut donc �galement r�cup�rer le centre
 * Dans l'algorithme on fait cette op�ration pour tous les points
 * Il serait judicieux d'entrer le cercle en param�tre
 * @param O
 * @return
 */
